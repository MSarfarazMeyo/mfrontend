...
import CanvasJSReact from '../../../assets/convas/canvasjs.react';
...
const Dashboard = () => {
  ...
  return (
    ...
    <Grid item xs={12}> 
        <Box p={"40px"} sx={{display:"flex" ,flexDirection:"row",justifyContent:"space-evenly", alignItems:"initial",borderBottom:"3px solid #4E39D7"}}>
         <Box sx={{display:"flex",flexDirection:"column"}}>
          <Typography 
           sx={{color:"#a1a8b0",fontSize:"14px",fontWeight:"500",lineHeight:"14px",textTransform:"uppercase"}}
          >NO. OF NFT STAKED TODAY</Typography>

          <Typography 
          sx={{color:"#edf0fc" ,fontFamily:"Poppins",fontWeight:500,fontSize:"32px",marginTop:"12px"}}
          >  O
             </Typography>
             <Button variant='contained' disabled sx={styles}> -- Vs LAST DAY</Button>
            </Box>
         <Box sx={{display:"flex",flexDirection:"column"}}>
          <Typography 
           sx={{color:"#a1a8b0",fontSize:"14px",fontWeight:"500",lineHeight:"14px",textTransform:"uppercase"}}
          >   % OF NFT STAKED TODAY   </Typography>
         ...
         <Box sx={{display:"flex",flexDirection:"column"}}>
          ...
          >  O
             ...
             <Button variant='contained' disabled sx={styles}> Check</Button>
            </Box>
            ...
            mt: 2,display:"flex",justifyContent:"right"
              ...
              <RangePicker/>
                        ...
                        <Box sx={{width:"100%",mt:2}}>
                         ...
                         {homepage ? (<CanvasJSChart options = {options} />):(   <CanvasJSChart options = {options1} />)}
        ...
        <Box p={"40px"} sx={{display:"flex" ,flexDirection:"row",justifyContent:"", alignItems:"initial",borderBottom:"3px solid #4E39D7"}}>
         ...
         <Box sx={{display:"flex",flexDirection:"column",paddingLeft:"8rem"}}>
          <Typography 
           sx={{color:"#a1a8b0",fontSize:"14px",fontWeight:"500",lineHeight:"14px",textTransform:"uppercase"}}
          >   % OF NFT STAKED TODAY   </Typography>
